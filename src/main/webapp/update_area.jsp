...
<%@ page import="com.user.User, com.todo.Todo"%>
	...
	<body>
		...
		<section class="sec add_sec">
			...
			<div class="container">
				...
				<% session.setAttribute("todo_id", request.getParameter("todo_id")); %>
				...
				>
					...
					<input 
						...
						value="<%= request.getParameter("todo_title") %>"
					...
					<input type="submit" class="submit-input" value="Update This!">
